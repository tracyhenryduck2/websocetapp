...
public class HekrLanguageUtil {
    ...
    public static String getLanguageTag(Context context) {
        return (getLanguage(context) == HekrLanguageUtil.LANGUAGE_zh_Hans) ? "zh-CN" : "en-US";
    }
    ...
    public static String getLanguageTag2(Context context) {
        return (getLanguage(context) == HekrLanguageUtil.LANGUAGE_zh_Hans) ? "zh_CN" : "en_US";
    }
