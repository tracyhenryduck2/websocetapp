...
/**
 * Created by hekr_xm on 2016/4/29.
 **/
public class LanDeviceBean implements Serializable {
    ...
    public LanDeviceBean(String binVer, String MAC, String SDKVer, String SSID, String binType, String bindKey, String devTid, String mid, String serviceHost, String serviceIp, int servicePort, int tokenType, int workMode) {
        this.binVer = binVer;
        this.MAC = MAC;
        this.SDKVer = SDKVer;
        this.SSID = SSID;
