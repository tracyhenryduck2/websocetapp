...
import com.siterwell.siterapp.MyApplication;
...
public class SpCache {
    ...
    private String mPrefFileName = "Siterwell";
    ...
    private void initDatas(String prefFileName) {
        if (null != prefFileName && prefFileName.trim().length() > 0) {
            ...
            com.litesuits.android.log.Log.d(TAG, "prefFileName is invalid , we will use default value ");
        }
    ...
    private <T> SpCache put(String key, T t) {
        ...
        if (t instanceof String) {
            ...
            com.litesuits.android.log.Log.d(TAG, "you may be put a invalid object :" + t);
    ...
    private Object readDisk(String key, Object defaultObject) {
        com.litesuits.android.log.Log.e("TAG", "readDisk");
        ...
        com.litesuits.android.log.Log.e(TAG, "you can not read object , which class is " + defaultObject.getClass().getSimpleName());
        return null;
