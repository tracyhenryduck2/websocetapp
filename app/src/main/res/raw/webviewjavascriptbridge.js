;(function() {
	...
	function _initHekrSDK(bridge) {
        ...
        function _share(shareStatus,callback){
          bridge.callHandler('share',{'shareStatus':shareStatus},function(ret){
          });
        }
        ...
        function _defaultBackClickHandel(data){
        }
        function _setBackClickHandel(handle){
          window.Hekr.backClickHandel = handle;
        }
        ...
        window.Hekr = {
          ...
          backClickHandel:_defaultBackClickHandel,
          send:_send,
          recv:_recv,
          ...
          setBackClickHandel:_setBackClickHandel,
          notify:_notify,
        ...
        bridge.registerHandler('onBackClick',function(data,callback){
          _defaultBackClickHandel(data);
          callback && callback({});
        })
